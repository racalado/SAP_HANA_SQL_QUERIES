SELECT * , 
CASE WHEN DTV1 = 0 THEN 'AGUARDAR CICLO 1'
WHEN URGRP = 200 AND DTV1 <> 0 AND MES1_PER < 0.2 THEN 'POS COMP - CANCELAR'
WHEN URGRP = 200 AND DTV1 <> 0 AND MES1_PER >= 0.2 THEN 'CALCULAR'
WHEN URGRP = 100 AND DTV1 > 0 AND DTV2 <> 0 AND MES2_PER < 0.2 THEN 'AGUARDAR CICLO 2'
WHEN URGRP = 100 AND DTV1 > 0 AND DTV2 > 0 AND DTV3 <> 0 THEN 'AGUARDAR CICLO 3'
WHEN URGRP = 100 AND DTV1 <> 0 AND DTV2 <> 0 AND DTV3 <> 0 AND
MES1_PER < 0.2 AND
MES2_PER < 0.2 AND
MES3_PER < 0.2 THEN 'POS COMP - CANCELAR'
WHEN URGRP = 100 AND 
